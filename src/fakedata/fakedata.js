...
import bannerComputer from "/images/banners/bannerComputer.jpg";
import bannerTechnology from "/images/banners/bannerTechnology.jpg";
...
const bannerData = [
    ...
    },
    {
        ...
        boxData: {
            ttl: "Mulai belajar",
            desc: "CourseIn adalah marketplace kursus terbaik yang ada di Indonesia",
        },
    },
    // {
    //     id: 3,
...
const filtersData = [
    {
        ...
        type: "radio",
        filtersData: [
            { txt: "lebih dari 4.5", count: "9998", stars: true, value: "4.5" },
            {
                txt: "lebih dari 4.0",
                count: "10000",
                stars: true,
